...
class Ui_win(object):
    def setupUi(self, win):
        ...
        self.tabWidget = QtGui.QTabWidget(win)
        ...
        self.label_2 = QtGui.QLabel(self.accTab)
        ...
        self.cr_clear = QtGui.QPushButton(self.accTab)
